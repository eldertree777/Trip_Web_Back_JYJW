	      ...
	      <div class="mt-5 pt-5">
	        <div class="container px-4">
	          ...
	          <div class="container rounded bg-secondary bg-opacity-25 text-secondary fs-2 p-4 mb-2">
	            ...
	            <div class="row  mt-2">
	              <div class="col-1">
	                <img src="../img/noimg.png" class="rounded-circle w-100" alt="noimg" />
	              </div>
	              <div class="col fs-4 text-dark">
	                이시영<br>
	                2022.07.07 11:11:11 조회 : 11
	              </div>
	            </div>
	          ...
	          <div class="d-flex justify-content-end">
	            <div class="text-nowrap ms-2">
	              <a class="btn btn-outline-primary" href="./list.html">
	                <!-- <i class="fas fa-table me-1"></i> -->
	                <i class="fas fa-edit"></i> 글목록
	              </a>
	            </div>
	            <div class="text-nowrap ms-2">
	              <a class="btn btn-outline-success" href="./modifylist.html">
	                <!-- <i class="fas fa-table me-1"></i> -->
