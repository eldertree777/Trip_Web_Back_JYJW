    ...
    <div class="p-3">
        ...
        <div class="row">
            <div class="col-md-6 p-3">
                <div class="alert alert-primary mt-3 text-center fw-bold" role="alert">전국 관광지 검색</div>
            ...
            <div class="col-md-6 p-3">
                <div class="row">
                    <div class="alert alert-primary mt-3 text-center fw-bold" role="alert">검색 결과 리스트</div>
